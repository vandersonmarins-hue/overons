...
import { FileText, Fuel, CheckCircle, TrendingUp, Download, Filter, Shield } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-gray-950 flex items-center justify-center p-6">
        <div className="bg-gray-900/80 rounded-2xl p-8 border border-white/10 max-w-sm w-full text-center">
          ...
          <p className="text-gray-400 text-sm mb-6">Área exclusiva da empresa</p>
